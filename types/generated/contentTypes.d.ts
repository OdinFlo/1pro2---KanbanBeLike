...
export interface ApiBoardBoard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    colonnes: Schema.Attribute.Relation<'oneToMany', 'api::colonne.colonne'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    a_faire: Schema.Attribute.Date;
    colonne: Schema.Attribute.Relation<'manyToOne', 'api::colonne.colonne'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    jours: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    represente_les_jours_de_la_semaine_actuelle: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiColonneColonne extends Struct.CollectionTypeSchema {
  collectionName: 'colonnes';
  info: {
    displayName: 'colonne';
    pluralName: 'colonnes';
    singularName: 'colonne';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    ordre: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    semaine: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::colonne.colonne': ApiColonneColonne;
